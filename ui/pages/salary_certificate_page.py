...
class SalaryCertificatePage(QWidget):
    ...
    def request_certificate(self) -> None:
        ...
        if certificate_id:
            QMessageBox.information(self, "Éxito", "Solicitud de constancia salarial solicitado exitosamente.")
        else:
            QMessageBox.critical(self, "Error", "Error al crear la solicitud de constancia de salario. Por favor, intente nuevamente.")